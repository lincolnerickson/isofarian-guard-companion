...
MAP_GRAPH = {
    "nodes": {
        # --- Ice Caves (IC) - underground, displayed at very top of map ---
        "ic_old_armory": {"x": 1380, "y": 80, "name": "Old Armory", "type": "special"},
        "ic_ossuary": {"x": 1560, "y": 80, "name": "Ossuary", "type": "special"},
        "ic_glacial_worm_bones": {"x": 1200, "y": 160, "name": "Glacial Worm Bones", "type": "special"},
        "ic_frozen_lake": {"x": 1350, "y": 150, "name": "Frozen Lake", "type": "special"},
        "ic_hall_of_ice": {"x": 1660, "y": 150, "name": "Hall of Ice", "type": "special"},
        "ic_abandoned_quarters": {"x": 1480, "y": 220, "name": "Abandoned Quarters", "type": "special"},
        # --- Frozen Wastes (FW) - snowy mountain surface ---
        "fw_mount_nebesa": {"x": 1760, "y": 260, "name": "Mount Nebesa", "type": "special"},
        "fw_ice_fields": {"x": 1550, "y": 310, "name": "Ice Fields", "type": "special"},
        "fw_room_of_columns": {"x": 1350, "y": 320, "name": "Room of Columns", "type": "special"},
        "fw_reka_glacier": {"x": 1150, "y": 360, "name": "Reka Glacier", "type": "special"},
        "fw_skryvat_temple": {"x": 1000, "y": 330, "name": "Skryvat Temple", "type": "special"},
        "fw_vniz_path": {"x": 1400, "y": 420, "name": "Vniz Path", "type": "special"},
        "fw_urok_span": {"x": 1600, "y": 440, "name": "Urok Span", "type": "special"},
        "fw_uchitel_span": {"x": 1250, "y": 460, "name": "Uchitel Span", "type": "special"},
        "fw_broken_lands": {"x": 850, "y": 430, "name": "The Broken Lands", "type": "special"},
        # --- Numbered nodes: Northern gateway (near FW/IC entrances) ---
        "1": {"x": 1450, "y": 540, "name": "1"},
        "2": {"x": 1300, "y": 580, "name": "2"},
        # --- Mountain passes ---
        "5": {"x": 1050, "y": 650, "name": "5"},
        "6": {"x": 1250, "y": 680, "name": "6"},
        "7": {"x": 1550, "y": 640, "name": "7"},
        "8": {"x": 1780, "y": 670, "name": "8"},
        # --- Towns: Fort Istra & Vouno ---
        "fort_istra": {"x": 1470, "y": 870, "name": "Fort Istra", "type": "town"},
        "vouno": {"x": 2080, "y": 680, "name": "Vouno", "type": "town"},
        # --- Fort Istra area ---
        "10": {"x": 1220, "y": 790, "name": "10"},
        "11": {"x": 1350, "y": 830, "name": "11"},
        "12": {"x": 1550, "y": 790, "name": "12"},
        "13": {"x": 1700, "y": 830, "name": "13"},
        "14": {"x": 1320, "y": 960, "name": "14"},
        "15": {"x": 1540, "y": 970, "name": "15"},
        # --- Upper valley ---
        "17": {"x": 1100, "y": 1100, "name": "17"},
        "18": {"x": 1350, "y": 1120, "name": "18"},
        "19": {"x": 1600, "y": 1080, "name": "19"},
        "21": {"x": 1230, "y": 1230, "name": "21"},
        # --- Central-north ---
        "23": {"x": 980, "y": 1330, "name": "23"},
        "24": {"x": 1180, "y": 1350, "name": "24"},
        "25": {"x": 1380, "y": 1310, "name": "25"},
        "26": {"x": 1580, "y": 1350, "name": "26"},
        "27": {"x": 950, "y": 1460, "name": "27"},
        "28": {"x": 1160, "y": 1470, "name": "28"},
        "29": {"x": 1400, "y": 1430, "name": "29"},
        "30": {"x": 1620, "y": 1470, "name": "30"},
        "31": {"x": 1850, "y": 1420, "name": "31"},
        # --- Town: Razdor ---
        "razdor": {"x": 1100, "y": 1580, "name": "Razdor", "type": "town"},
        # --- Central ---
        "34": {"x": 800, "y": 1600, "name": "34"},
        "35": {"x": 1000, "y": 1630, "name": "35"},
        "36": {"x": 1220, "y": 1650, "name": "36"},
        "37": {"x": 1420, "y": 1610, "name": "37"},
        "38": {"x": 1630, "y": 1630, "name": "38"},
        "39": {"x": 1870, "y": 1590, "name": "39"},
        "40": {"x": 900, "y": 1750, "name": "40"},
        "41": {"x": 1150, "y": 1770, "name": "41"},
        "42": {"x": 1400, "y": 1760, "name": "42"},
        # --- Central-south ---
        "44": {"x": 1650, "y": 1760, "name": "44"},
        "45": {"x": 1880, "y": 1780, "name": "45"},
        "46": {"x": 1000, "y": 1880, "name": "46"},
        "47": {"x": 1220, "y": 1920, "name": "47"},
        "50": {"x": 1450, "y": 1900, "name": "50"},
        # --- River east ---
        "52": {"x": 1680, "y": 1950, "name": "52"},
        "53": {"x": 1900, "y": 2000, "name": "53"},
        # --- Town: Silny ---
        "silny": {"x": 1850, "y": 2150, "name": "Silny", "type": "town"},
        # --- Town: Strofa ---
        "strofa": {"x": 650, "y": 2200, "name": "Strofa", "type": "town"},
        # --- West-central ---
        "57": {"x": 800, "y": 2080, "name": "57"},
        "58": {"x": 1020, "y": 2060, "name": "58"},
        # --- South-central ---
        "61": {"x": 1220, "y": 2100, "name": "61"},
        "62": {"x": 1450, "y": 2150, "name": "62"},
        "63": {"x": 1680, "y": 2200, "name": "63"},
        "64": {"x": 1920, "y": 2250, "name": "64"},
        "65": {"x": 1000, "y": 2300, "name": "65"},
        "66": {"x": 1220, "y": 2330, "name": "66"},
        "67": {"x": 1450, "y": 2370, "name": "67"},
        "68": {"x": 1700, "y": 2420, "name": "68"},
        # --- Lower ---
        "71": {"x": 1000, "y": 2530, "name": "71"},
        "72": {"x": 1230, "y": 2560, "name": "72"},
        "73": {"x": 1450, "y": 2600, "name": "73"},
        "76": {"x": 1680, "y": 2640, "name": "76"},
        "77": {"x": 1920, "y": 2600, "name": "77"},
        # --- Southern ---
        "80": {"x": 1000, "y": 2750, "name": "80"},
        "82": {"x": 1230, "y": 2790, "name": "82"},
        "83": {"x": 1450, "y": 2830, "name": "83"},
        "84": {"x": 1680, "y": 2810, "name": "84"},
        "85": {"x": 1920, "y": 2770, "name": "85"},
        # --- Town: Ryba ---
        "ryba": {"x": 1300, "y": 2930, "name": "Ryba", "type": "town"},
        "86": {"x": 1000, "y": 2950, "name": "86"},
        "87": {"x": 1220, "y": 2990, "name": "87"},
        "88": {"x": 1450, "y": 3040, "name": "88"},
        "89": {"x": 1680, "y": 3080, "name": "89"},
        "90": {"x": 1000, "y": 3180, "name": "90"},
        "91": {"x": 1220, "y": 3230, "name": "91"},
        "92": {"x": 1450, "y": 3280, "name": "92"},
        "93": {"x": 1700, "y": 3320, "name": "93"},
        # --- Near Mir ---
        "97": {"x": 1200, "y": 3470, "name": "97"},
        "98": {"x": 1430, "y": 3520, "name": "98"},
        "99": {"x": 1680, "y": 3490, "name": "99"},
        "103": {"x": 1200, "y": 3650, "name": "103"},
        "104": {"x": 1450, "y": 3700, "name": "104"},
        "105": {"x": 1700, "y": 3660, "name": "105"},
        "108": {"x": 1450, "y": 3900, "name": "108"},
        # --- Town: Mir ---
        "mir": {"x": 1550, "y": 3800, "name": "Mir", "type": "town"},
    },
    "edges": [
        ...
        ["vouno", "13"],
        ["vouno", "31"],
        # === Fort Istra to upper valley ===
        ["14", "17"],
        ["14", "18"],
        ["15", "18"],
        ["15", "19"],
        # === Upper valley (17-19, 21) ===
        ["17", "18"],
        ["18", "19"],
        ["17", "21"],
        ["18", "21"],
        # === Upper valley to central-north ===
        ["21", "23"],
        ["21", "24"],
        ["19", "25"],
        ["19", "26"],
        ...
        ["41", "42"],
        ["42", "44"],
        # === Central to central-south ===
        ["38", "44"],
        ["39", "45"],
        ["40", "46"],
        ["41", "47"],
        ["42", "50"],
        # === Central-south (44-47, 50, 52-53) ===
        ["44", "45"],
        ["44", "50"],
        ["46", "47"],
        ["47", "50"],
