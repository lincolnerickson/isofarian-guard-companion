...
MAP_GRAPH = {
    "nodes": {
        ...
        "3": {"x": 2089, "y": 596, "name": "3"},
        "4": {"x": 2605, "y": 603, "name": "4"},
        "5": {"x": 2004, "y": 657, "name": "5"},
        "6": {"x": 550, "y": 817, "name": "6"},
        "7": {"x": 1352, "y": 755, "name": "7"},
        "8": {"x": 369, "y": 1049, "name": "8"},
        "9": {"x": 1727, "y": 768, "name": "9"},
        "10": {"x": 1857, "y": 770, "name": "10"},
        "11": {"x": 2066, "y": 899, "name": "11"},
        "12": {"x": 2654, "y": 742, "name": "12"},
        "13": {"x": 2487, "y": 886, "name": "13"},
        "14": {"x": 1680, "y": 969, "name": "14"},
        "15": {"x": 2523, "y": 1027, "name": "15"},
        "16": {"x": 1618, "y": 1125, "name": "16"},
        "17": {"x": 2251, "y": 1076, "name": "17"},
        "18": {"x": 2603, "y": 1079, "name": "18"},
        "19": {"x": 2369, "y": 1184, "name": "19"},
        "20": {"x": 1427, "y": 1309, "name": "20"},
        "21": {"x": 2842, "y": 1341, "name": "21"},
        "22": {"x": 2441, "y": 1377, "name": "22"},
        "23": {"x": 302, "y": 1342, "name": "23"},
        "24": {"x": 454, "y": 1530, "name": "24"},
        "25": {"x": 1221, "y": 1494, "name": "25"},
        "26": {"x": 1449, "y": 1466, "name": "26"},
        "27": {"x": 1715, "y": 1453, "name": "27"},
        "28": {"x": 1453, "y": 1663, "name": "28"},
        "29": {"x": 1577, "y": 1635, "name": "29"},
        "30": {"x": 1627, "y": 1726, "name": "30"},
        "31": {"x": 1824, "y": 1730, "name": "31"},
        "32": {"x": 1973, "y": 1714, "name": "32"},
        "33": {"x": 2405, "y": 1693, "name": "33"},
        "34": {"x": 2572, "y": 1754, "name": "34"},
        "35": {"x": 2425, "y": 1765, "name": "35"},
        "36": {"x": 283, "y": 1840, "name": "36"},
        "37": {"x": 807, "y": 1810, "name": "37"},
        "38": {"x": 1267, "y": 1807, "name": "38"},
        "39": {"x": 1934, "y": 1850, "name": "39"},
        "40": {"x": 2420, "y": 1926, "name": "40"},
        "41": {"x": 2518, "y": 1937, "name": "41"},
        "42": {"x": 2801, "y": 1970, "name": "42"},
        "43": {"x": 299, "y": 1967, "name": "43"},
        "44": {"x": 695, "y": 2023, "name": "44"},
        "45": {"x": 1098, "y": 2030, "name": "45"},
        "46": {"x": 1280, "y": 2008, "name": "46"},
        "47": {"x": 1772, "y": 2015, "name": "47"},
        "48": {"x": 2433, "y": 2047, "name": "48"},
        "49": {"x": 1289, "y": 2096, "name": "49"},
        "50": {"x": 2598, "y": 2243, "name": "50"},
        "51": {"x": 399, "y": 2274, "name": "51"},
        "52": {"x": 770, "y": 2236, "name": "52"},
        "53": {"x": 1006, "y": 2265, "name": "53"},
        "54": {"x": 1109, "y": 2261, "name": "54"},
        "55": {"x": 1437, "y": 2239, "name": "55"},
        "56": {"x": 1251, "y": 2386, "name": "56"},
        "57": {"x": 1713, "y": 2237, "name": "57"},
        "58": {"x": 1969, "y": 2222, "name": "58"},
        "59": {"x": 2204, "y": 2261, "name": "59"},
        "60": {"x": 2418, "y": 2253, "name": "60"},
        "61": {"x": 936, "y": 2426, "name": "61"},
        "62": {"x": 1860, "y": 2366, "name": "62"},
        "63": {"x": 2399, "y": 2388, "name": "63"},
        "64": {"x": 476, "y": 2640, "name": "64"},
        "65": {"x": 1016, "y": 2586, "name": "65"},
        "66": {"x": 1479, "y": 2547, "name": "66"},
        "67": {"x": 1686, "y": 2532, "name": "67"},
        "68": {"x": 2311, "y": 2528, "name": "68"},
        "69": {"x": 2322, "y": 2603, "name": "69"},
        "70": {"x": 1475, "y": 2637, "name": "70"},
        "71": {"x": 348, "y": 2954, "name": "71"},
        "72": {"x": 496, "y": 2904, "name": "72"},
        "73": {"x": 712, "y": 2940, "name": "73"},
        "74": {"x": 1141, "y": 2790, "name": "74"},
        "75": {"x": 1460, "y": 2762, "name": "75"},
        "76": {"x": 1689, "y": 2768, "name": "76"},
        "77": {"x": 1969, "y": 2742, "name": "77"},
        "78": {"x": 2232, "y": 2745, "name": "78"},
        "79": {"x": 2593, "y": 2773, "name": "79"},
        "80": {"x": 1931, "y": 2854, "name": "80"},
        "81": {"x": 2286, "y": 2849, "name": "81"},
        "82": {"x": 2855, "y": 2838, "name": "82"},
        "83": {"x": 1025, "y": 3035, "name": "83"},
        "84": {"x": 1125, "y": 2969, "name": "84"},
        "85": {"x": 1460, "y": 3037, "name": "85"},
        "86": {"x": 1794, "y": 3080, "name": "86"},
        "87": {"x": 2259, "y": 3034, "name": "87"},
        "88": {"x": 469, "y": 3441, "name": "88"},
        "89": {"x": 826, "y": 3373, "name": "89"},
        "90": {"x": 1164, "y": 3252, "name": "90"},
        "91": {"x": 1510, "y": 3281, "name": "91"},
        "92": {"x": 1828, "y": 3176, "name": "92"},
        "93": {"x": 2139, "y": 3171, "name": "93"},
        "94": {"x": 1615, "y": 3344, "name": "94"},
        "95": {"x": 2086, "y": 3252, "name": "95"},
        "96": {"x": 921, "y": 3512, "name": "96"},
        "97": {"x": 1051, "y": 3500, "name": "97"},
        "98": {"x": 1264, "y": 3490, "name": "98"},
        "99": {"x": 1105, "y": 3636, "name": "99"},
        "100": {"x": 1637, "y": 3694, "name": "100"},
        "101": {"x": 703, "y": 3816, "name": "101"},
        "102": {"x": 1046, "y": 3788, "name": "102"},
        "103": {"x": 1368, "y": 3811, "name": "103"},
        "104": {"x": 1597, "y": 3755, "name": "104"},
        "105": {"x": 1723, "y": 3804, "name": "105"},
        "106": {"x": 1199, "y": 3883, "name": "106"},
        "107": {"x": 761, "y": 3955, "name": "107"},
        "108": {"x": 649, "y": 4319, "name": "108"},
        # --- Named locations ---
        "forgotten tower": {"x": 1006, "y": 4301, "name": "Forgotten Tower"},
        # --- Towns ---
        "fort_istra": {"x": 949, "y": 3875, "name": "Fort Istra", "type": "town"},
        "razdor": {"x": 2031, "y": 3502, "name": "Razdor", "type": "town"},
        "mir": {"x": 1349, "y": 2737, "name": "Mir", "type": "town"},
        "ryba": {"x": 2426, "y": 2742, "name": "Ryba", "type": "town"},
        "vouno": {"x": 285, "y": 2129, "name": "Vouno", "type": "town"},
        "silny": {"x": 2236, "y": 1559, "name": "Silny", "type": "town"},
        "strofa": {"x": 1253, "y": 2304, "name": "Strofa", "type": "town"},
        # --- FW (Frozen Wastes) special area nodes ---
        "fw_tumani_village": {"x": 2194, "y": 538, "name": "FW - Tumani Village", "type": "special"},
        "fw_reka_glacier": {"x": 2217, "y": 462, "name": "FW - Reka Glacier", "type": "special"},
        "fw_uchitel_span": {"x": 2401, "y": 480, "name": "FW - Uchitel Span", "type": "special"},
        "fw_vniz_path": {"x": 2497, "y": 434, "name": "FW - Vniz Path", "type": "special"},
        "fw_skryvat_temple": {"x": 2526, "y": 392, "name": "FW - Skryvat Temple", "type": "special"},
        "fw_room_of_columns": {"x": 2620, "y": 375, "name": "FW - Room of Columns", "type": "special"},
        "fw_broken_lands": {"x": 2656, "y": 503, "name": "FW - Broken Lands", "type": "special"},
        "fw_ice_fields": {"x": 2842, "y": 544, "name": "FW - Ice Fields", "type": "special"},
        "fw_urok_span": {"x": 2513, "y": 551, "name": "FW - Urok Span", "type": "special"},
        "fw_diamond_vein": {"x": 2219, "y": 405, "name": "FW - Diamond Vein", "type": "special"},
        "fw_mount_nebesa": {"x": 2183, "y": 342, "name": "FW - Mount Nebesa", "type": "special"},
        # --- IC (Ice Caves) special area nodes ---
        "ic_ossuary": {"x": 1619, "y": 684, "name": "IC - Ossuary", "type": "special"},
        "ic_old_armory": {"x": 1565, "y": 564, "name": "IC - Old Armory", "type": "special"},
        "ic_glacial_worm_bones": {"x": 1673, "y": 489, "name": "IC - Glacial Worm Bones", "type": "special"},
        "ic_crystal_vein": {"x": 1785, "y": 541, "name": "IC - Crystal Vein", "type": "special"},
        "ic_abandoned_quarters": {"x": 1744, "y": 628, "name": "IC - Abandoned Quarters", "type": "special"},
        "ic_hall_of_ice": {"x": 1885, "y": 608, "name": "IC - Hall of Ice", "type": "special"},
        "ic_frozen_lake": {"x": 1882, "y": 446, "name": "IC - Frozen Lake", "type": "special"},
        "ic_dark_hall": {"x": 1466, "y": 480, "name": "IC - Dark Hall", "type": "special"},
        "ic_hall_of_guardians": {"x": 1468, "y": 396, "name": "IC - Hall of Guardians", "type": "special"},
        "ic_pit": {"x": 1516, "y": 369, "name": "IC - Pit", "type": "special"},
        "ic_receiving_room": {"x": 1675, "y": 606, "name": "IC - Receiving Room", "type": "special"},
    },
    "edges": [
        ...
        ["108", "107"],
        ["forgotten tower", "108"],
        # === FW (Frozen Wastes) connections ===
        ["3", "fw_tumani_village"],
        ["4", "fw_urok_span"],
        ["fw_tumani_village", "fw_reka_glacier"],
        ["fw_tumani_village", "fw_uchitel_span"],
        ["fw_uchitel_span", "fw_vniz_path"],
        ["fw_vniz_path", "fw_skryvat_temple"],
        ["fw_skryvat_temple", "fw_room_of_columns"],
        ["fw_urok_span", "fw_tumani_village"],
        ["fw_urok_span", "fw_uchitel_span"],
        ["fw_urok_span", "fw_broken_lands"],
        ["fw_broken_lands", "fw_ice_fields"],
        ["fw_broken_lands", "fw_uchitel_span"],
        ["fw_reka_glacier", "fw_diamond_vein"],
        ["fw_diamond_vein", "fw_mount_nebesa"],
        # === IC (Ice Caves) connections ===
        ["9", "ic_ossuary"],
        ["ic_ossuary", "ic_old_armory"],
        ["ic_old_armory", "ic_glacial_worm_bones"],
        ["ic_glacial_worm_bones", "ic_crystal_vein"],
        ["ic_crystal_vein", "ic_abandoned_quarters"],
        ["ic_crystal_vein", "9"],
        ["9", "ic_hall_of_ice"],
        ["ic_hall_of_ice", "ic_frozen_lake"],
        ["ic_glacial_worm_bones", "ic_receiving_room"],
        ["ic_receiving_room", "ic_dark_hall"],
        ["ic_dark_hall", "ic_hall_of_guardians"],
        ["ic_hall_of_guardians", "ic_pit"],
    ]
}

# Lookup table for location string -> node ID mapping
SPECIAL_AREA_NAME_TO_ID = {
    "FW - Broken Lands": "fw_broken_lands",
    "FW - Diamond Vein": "fw_diamond_vein",
    ...
    "FW - The Broken Lands": "fw_broken_lands",  # alternate name
    "FW - Tumani Village": "fw_tumani_village",
...
.search-dropdown-cat { font-size: 0.7rem; font-weight: 600; padding: 2px 6px; border-radius: 3px; text-transform: uppercase; white-space: nowrap; }
.search-dropdown-cat.cat-enemy { background: var(--red); color: #fff; }
.search-dropdown-cat.cat-armor { background: #1976d2; color: #fff; }
.search-dropdown-cat.cat-weapon { background: #7b1fa2; color: #fff; }
.search-dropdown-cat.cat-accessory { background: var(--orange); color: #1a1a2e; }
.search-dropdown-cat.cat-item { background: #00897b; color: #fff; }
.search-dropdown-cat.cat-material { background: var(--green); color: #1a1a2e; }
.search-dropdown-cat.cat-market { background: var(--gold); color: #1a1a2e; }
.search-dropdown-cat.cat-stone { background: var(--purple); color: #fff; }
.search-dropdown-cat.cat-building { background: var(--text2); color: #1a1a2e; }
...
.lux-icon { display:inline-block; width:14px; height:14px; vertical-align:middle; margin-right:2px; }
...
.rp-item-search-wrap { position: relative; }
.rp-item-dropdown { display: none; position: absolute; top: 100%; left: 0; right: 0; background: var(--bg2); border: 1px solid var(--accent); border-radius: 0 0 6px 6px; max-height: 250px; overflow-y: auto; z-index: 100; box-shadow: 0 6px 16px rgba(0,0,0,0.5); }
.rp-item-dropdown.active { display: block; }
.rp-item-dropdown-item { padding: 6px 10px; cursor: pointer; font-size: 0.85rem; display: flex; align-items: center; gap: 6px; border-bottom: 1px solid rgba(255,255,255,0.05); }
.rp-item-dropdown-item:last-child { border-bottom: none; }
.rp-item-dropdown-item:hover { background: rgba(255,255,255,0.08); }
.rp-item-dropdown-cat { font-size: 0.65rem; font-weight: 600; padding: 1px 5px; border-radius: 3px; text-transform: uppercase; }
.rp-item-dropdown-group { padding: 4px 10px; font-size: 0.7rem; color: var(--text2); font-weight: 600; text-transform: uppercase; background: var(--bg3); }
  ...
  <div class="panel" id="panel-route-planner">
    <div class="rp-container">
      <div class="rp-sidebar">
        ...
        <div class="rp-item-search-wrap">
          <input type="text" id="rp-item-search" placeholder="Search items to add..." autocomplete="off" style="width:100%;" />
          <div id="rp-item-dropdown" class="rp-item-dropdown"></div>
        </div>
        ...
        <div style="margin:8px 0;">
          <label style="color:var(--text2);font-size:0.85rem;">Source Types</label>
          <div class="rep-toggle" style="margin-top:4px;width:100%;display:flex;">
            <button id="rp-src-all" class="active" onclick="rpSourceMode='all';document.getElementById('rp-src-all').classList.add('active');document.getElementById('rp-src-enemies').classList.remove('active');" style="flex:1;">All Sources</button>
            <button id="rp-src-enemies" onclick="rpSourceMode='enemies';document.getElementById('rp-src-enemies').classList.add('active');document.getElementById('rp-src-all').classList.remove('active');" style="flex:1;">Enemies Only</button>
          </div>
        </div>
...
function formatCost(s, prefix) {
  ...
  return s.split(/\n/).map(part => {
    ...
    // Add prefix before leading number
    if (prefix) part = part.replace(/^(\d)/, prefix + '$1');
    return part;
  }).filter(Boolean).join(', ');
}
const LUX_ICON = '✨';
...
function showDetail(type, identifier) {
  ...
  if (type === 'enemy') {
    ...
    entries.forEach(e => {
      ...
      if (e.lux) html += '<span class="stat lux"><span class="stat-label">Lux</span><span class="stat-value">' + LUX_ICON + esc(e.lux) + '</span></span>';
    ...
    if (item.luxCost && item.luxCost !== '-') html += '<span class="stat lux"><span class="stat-label">Lux</span><span class="stat-value">' + LUX_ICON + esc(formatCost(item.luxCost, '')) + '</span></span>';
    html += '</div>';
      ...
      const renderMats = (group, category) => {
        Object.entries(group).forEach(([mat, info]) => {
          ...
          if (materialToMarket[mat]) {
            let mkt = materialToMarket[mat];
            let townParts = [];
            Object.entries(mkt.prices).forEach(([town, p]) => {
              let price = getMarketBuyPrice(mat, town);
              if (price) townParts.push(esc(town) + ' ' + esc(price));
            });
            if (townParts.length) {
              if (source) source += ' | ';
              source += '<span style="color:var(--green)">Market: ' + townParts.join(', ') + '</span>';
            }
          }
    ...
    // Plan Route / Add to Route links
    if (hasMats) {
      html += '<div style="margin-top:14px;display:flex;gap:8px;">';
      html += '<a class="rp-btn rp-btn-primary" style="text-decoration:none;" onclick="planRouteFor(\'' + escJs(item.name) + '\')">Plan Route</a>';
      html += '<a class="rp-btn" style="text-decoration:none;border:1px solid var(--accent);color:var(--accent);" onclick="addToRoutePlanner(\'' + escJs(item.name) + '\')">+ Add to Route</a>';
      html += '</div>';
    }
...
function getMarketRep() {
  try {
    let raw = localStorage.getItem('tig_market_rep');
    if (!raw) return {};
    let obj = JSON.parse(raw);
...
function saveMarketRep(obj) {
  localStorage.setItem('tig_market_rep', JSON.stringify(obj));
}

function getTownRep(town) {
  return getMarketRep()[town] || 0;
}

function setTownRep(town, level) {
  let rep = getMarketRep();
  rep[town] = level;
  saveMarketRep(rep);
}

function isPrice(v) { return v && v !== '-'; }

function getMarketBuyPrice(mat, town) {
  let m = materialToMarket[mat];
  if (!m) return null;
  let p = m.prices[town];
  if (!p) return null;
  let rep = getTownRep(town);
  if (rep >= 2 && isPrice(p.buy2Rep)) return p.buy2Rep;
  if (isPrice(p.buy)) return p.buy;
  return null;
}
...
function updateSearchDropdown(query) {
  ...
  // Enemies (unique names)
  DATA.enemies.forEach(e => {
    if (results.length >= MAX || seen['enemy:'+e.name]) return;
    if (e.name.toLowerCase().includes(q)) {
      seen['enemy:'+e.name] = 1;
      results.push({name: e.name, cat: 'Enemy', cls: 'cat-enemy', type: 'enemy', id: e.name});
    }
  });
  ...
  DATA.armorWeapons.forEach(i => {
    ...
    if (i.name.toLowerCase().includes(q)) {
      let isWeapon = (i.type||'').toLowerCase().includes('weapon') || (i.type||'').toLowerCase().includes('shield');
      results.push({name: i.name, cat: isWeapon ? 'Weapon' : 'Armor', cls: isWeapon ? 'cat-weapon' : 'cat-armor', type: 'craft', id: i.name});
    }
  });
  ...
  DATA.accessories.forEach(i => {
    if (results.length >= MAX) return;
    if (i.name.toLowerCase().includes(q)) {
      let isItem = (i.type||'').toLowerCase().includes('item');
      results.push({name: i.name, cat: isItem ? 'Item' : 'Accessory', cls: isItem ? 'cat-item' : 'cat-accessory', type: 'craft', id: i.name});
    }
  });

  // Materials (harvest locations keys)
  Object.keys(DATA.harvestLocations).forEach(mat => {
    if (results.length >= MAX) return;
    if (mat.toLowerCase().includes(q)) {
      results.push({name: mat, cat: 'Material', cls: 'cat-material', type: 'material', id: mat});
    }
  });

  // Market items
  DATA.market.forEach(i => {
    if (results.length >= MAX || seen['market:'+i.name]) return;
    if (i.name.toLowerCase().includes(q)) {
      seen['market:'+i.name] = 1;
      results.push({name: i.name, cat: 'Market', cls: 'cat-market', type: 'material', id: i.name});
    }
  });

  // Speaking Stones
  if (DATA.speakingStones) DATA.speakingStones.forEach(s => {
    if (results.length >= MAX) return;
    if (s.name.toLowerCase().includes(q)) {
      results.push({name: s.name, cat: 'Stone', cls: 'cat-stone', type: 'stone', id: s.name});
    }
  });
  ...
  if (DATA.buildings) DATA.buildings.forEach(b => {
    ...
    if (b.name.toLowerCase().includes(q)) {
      results.push({name: b.name, cat: 'Building', cls: 'cat-building', type: 'building', id: b.name});
    }
  });
  ...
  dropdown.innerHTML = results.map(r =>
    '<div class="search-dropdown-item" data-type="' + esc(r.type) + '" data-id="' + esc(r.id) + '">' +
    '<span class="search-dropdown-cat ' + r.cls + '">' + esc(r.cat) + '</span>' +
...
document.getElementById('globalSearch').addEventListener('focusin', () => {
  const q = document.getElementById('globalSearch').value.trim();
  if (q.length >= 2) updateSearchDropdown(q);
});
...
const WATER_DOCKS = new Set(['101', '79', '56', '21', '11']);
const WATER_ONLY_NODES = new Set(['82', '50', '42', '27', '39', '47', '66', '65', '89', '80']);
...
function rpBuildAdj() {
  ...
  RP.graph.edges.forEach(e => {
    ...
    // Non-water edges: skip if either endpoint is a water-only node
    // (water-only nodes can only be reached via water edges through docks)
    if (!isWater) {
      if (WATER_ONLY_NODES.has(a) || WATER_ONLY_NODES.has(b)) return;
    }

    // Water edges: only allow if at least one endpoint is a dock or
    // the traveler is already on the water network (both are water nodes)
    if (isWater) {
      const aOnWater = WATER_DOCKS.has(a) || WATER_ONLY_NODES.has(a);
      const bOnWater = WATER_DOCKS.has(b) || WATER_ONLY_NODES.has(b);
      if (!aOnWater || !bOnWater) return;
    }
...
function rpBindEvents() {
  ...
  document.getElementById('rp-item-dropdown').addEventListener('click', e => {
    const item = e.target.closest('.rp-item-dropdown-item');
    if (!item) return;
    const name = item.dataset.name;
    if (name) {
      rpAddItemByName(name);
      document.getElementById('rp-item-search').value = '';
      document.getElementById('rp-item-dropdown').classList.remove('active');
    }
  });
  document.getElementById('rp-item-search').addEventListener('focusin', () => {
    const q = document.getElementById('rp-item-search').value.trim();
    if (q.length >= 1) rpFilterItemDropdown(q);
  });
  document.addEventListener('click', e => {
    if (!e.target.closest('.rp-item-search-wrap')) {
      document.getElementById('rp-item-dropdown').classList.remove('active');
    }
  });
}
...
function rpFilterItemDropdown(query) {
  const dd = document.getElementById('rp-item-dropdown');
  const q = (query || '').toLowerCase();
  if (!q || q.length < 1) { dd.classList.remove('active'); return; }
  const groups = { 'Armor': [], 'Weapon': [], 'Accessory': [], 'Item': [], 'Building': [] };
  const catColors = { 'Armor': 'cat-armor', 'Weapon': 'cat-weapon', 'Accessory': 'cat-accessory', 'Item': 'cat-item', 'Building': 'cat-building' };
  DATA.armorWeapons.forEach(i => {
    const t = (i.type || '').includes('Armor') ? 'Armor' : 'Weapon';
    if (i.name.toLowerCase().includes(q)) groups[t].push(i.name);
  });
  DATA.accessories.forEach(i => {
    const t = (i.type || '').includes('Accessory') ? 'Accessory' : 'Item';
    if (i.name.toLowerCase().includes(q)) groups[t].push(i.name);
  ...
  DATA.buildings.forEach(i => {
    if (i.name.toLowerCase().includes(q)) groups['Building'].push(i.name);
  });
  let html = '';
  let total = 0;
  for (const [group, items] of Object.entries(groups)) {
    if (!items.length) continue;
    html += '<div class="rp-item-dropdown-group">' + esc(group) + '</div>';
    items.sort().forEach(name => {
      html += '<div class="rp-item-dropdown-item" data-name="' + esc(name) + '">';
      html += '<span class="search-dropdown-cat ' + (catColors[group] || '') + '">' + esc(group) + '</span>';
      html += '<span>' + esc(name) + '</span></div>';
      total++;
    });
  }
  if (!total) { dd.classList.remove('active'); return; }
  dd.innerHTML = html;
...
let rpItemList = [];
let rpSourceMode = 'all'; // 'all' or 'enemies'
...
function rpAddItemByName(itemName) {
